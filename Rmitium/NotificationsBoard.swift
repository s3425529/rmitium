...
import SpriteKit
class textView: SKScene, UITextViewDelegate {
    ...
    override func didMoveToView(view: SKView) {
        ...
        // Same for the height.
        highScoreText = UITextView(frame: CGRectMake(view.bounds.width / 2 - 160, view.bounds.height / 2 - 20, 320, 40))
        ...
        highScoreText.borderStyle = UITextView.B
