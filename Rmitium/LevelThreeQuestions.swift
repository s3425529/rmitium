...
enum LevelThreeQuestion:Int {
    ...
    var facts:[String] {
        get {
            ...
            case .QuestionTen: return ["Acetic acid, systematically named ethanoic acid, is the second simplest carboxylic acid.","Vinegar is actually a solution of 4-8% of acetic acid that is dissolved in water and other substances.","In the popular volcano science experiment seen in many schools the 'lava' is acetic acid in vinegar reacting with baking soda coloured with red food dye.","Water free acetic acid is sometimes called glacial acetic acid. The German name for this is Eisessig (literally, ice-vinegar).","The term acetate is used when referring to the carboxylate anion or any of the salts or esters of acetic acid.","In households, diluted acetic acid is often used in descaling agents.","The most common and official abbreviation for acetic acid is AcOH or HOAc where Ac stands for the acetyl group (not the chemical element actinium).","The presence of water in vinegar has such a profound effect on acetic acid's properties that for centuries many chemists believed that glacial (water free) acetic acid and the acid found in vinegar were two different substances.","Acetic acid is corrosive to many metals including iron, magnesium, and zinc, forming hydrogen gas and metal salts called acetates.","Liquid acetic acid is a hydrophilic (polar) protic solvent, similar to ethanol and water. It can dissolve both polar compounds and non-polar compounds."]
